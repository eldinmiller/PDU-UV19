...
int kill_function(void){
	if(kill_flag > 0){
			//PORTA = 0;
			/*
			pdu_output_20a_disable(1);
			pdu_output_20a_disable(2);
			pdu_output_20a_disable(3);
			pdu_output_20a_disable(4);
			pdu_output_20a_disable(5);
			pdu_output_20a_disable(6);
			pdu_output_20a_disable(7);
			*/
